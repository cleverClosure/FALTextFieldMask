...
class FALTextFieldMask : NSObject, UITextFieldDelegate {
    ...
    @objc func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if num != nil {
            ...
            var charAtIndex = textField.textMask.characters[textField.textMask.index(textField.textMask.startIndex, offsetBy: num!)]
            ...
            while( charAtIndex != "N" && charAtIndex != "F" && charAtIndex != "S" ) {
                ...
                charAtIndex = textField.textMask.characters[textField.textMask.index(textField.textMask.startIndex, offsetBy: num!)]
